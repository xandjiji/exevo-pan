...
export const storeItems: Record<string, StoreItem> = {
  ...
  'paramedic demon': { name: 'Paramedic Demon', value: 250 },
  'red panda': { name: 'Red Panda', value: 180 },
  'sighting bed': { name: 'Sighting Bed', value: 150 },
  'sighting lamp': { name: 'Sighting Lamp', value: 80 },
  'sighting chest': { name: 'Sighting Chest', value: 70 },
  'sighting table': { name: 'Sighting Table', value: 80 },
  'tiny sight of surrender': { name: 'Tiny Sight of Surrender', value: 180 },
  'sighting cabinet': { name: 'Sighting Cabinet', value: 90 },
  'sighting chair': { name: 'Sighting Chair', value: 60 },
  'voodoo chest': { name: 'Voodoo Chest', value: 70 },
  'voodoo cabinet': { name: 'Voodoo Cabinet', value: 100 },
  'voodoo bed': { name: 'Voodoo Bed', value: 150 },
  'voodoo table': { name: 'Voodoo Table', value: 80 },
  'voodoo chair': { name: 'Voodoo Chair', value: 70 },
  'voodoo lamp': { name: 'Voodoo Lamp', value: 80 },
  'voodoo carpet': { name: 'Voodoo Carpet', value: 30 },
  'voodoo doll': { name: 'Voodoo Doll', value: 180 },
  'voodoo mask': { name: 'Voodoo Mask', value: 80 },
  'wooden dummy': { name: 'Wooden Dummy', value: 100 },
  'wicker chest': { name: 'Wicker Chest', value: 60 },
  'effigy of winged vengeance': {
    name: 'Effigy of Winged Vengeance',
    value: 120,
  },
  'pink blossom lamp': {
