...
const MiniAuction = () => (
  <div className="bg-surface flex h-56 w-40 flex-col gap-3 rounded-xl p-4 shadow-md">
    <div className="flex gap-2">
      <div className="bg-primaryVariant grid h-9 w-9 place-items-center rounded-xl opacity-50">
    ...
    <div className="child:h-1 child:rounded grid grid-cols-2 gap-2">
      <div className="bg-onSurface w-12 opacity-20" />
      <div className="bg-onSurface  w-14 opacity-20" />
      <div className="bg-onSurface w-10 opacity-20" />
