...
export const ExevoProCTA = () => {
  ...
  return (
    <a
      className="bg-surface text-onSurface clickable animate-fadeIn z-71 border-1 border-separator/50 text-s fixed bottom-[66px] left-[calc(100vw-12px)] flex items-center gap-2 whitespace-nowrap rounded-md border-solid py-2.5 px-3 shadow md:bottom-[122px] md:left-[calc(100vw-24px)] md:py-2"
