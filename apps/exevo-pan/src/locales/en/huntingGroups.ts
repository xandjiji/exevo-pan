export default {
  ...
  MemberList: {
    ...
    ManagingModes: {
      ...
      ChangeName: {
        ...
        cancel: 'Cancel',
        confirm: 'Confirm',
        successToast: 'Name was updated successfully!',
      },
    },
  },
  SettingsDialog: {
  ...
  CheckedBosses: {
    ...
    hideRook: 'Hide Rookgaard {{bosses}}',
    hideCreature: 'Hide {{creatures}}',
    hideHiveStage3: 'Hide Hive Stage 3 {{bosses}}',
    hideVampire: 'Hide vampire {{bosses}}',
    hideBank: 'Hide bank {{bosses}}',
    hideInfernoPits: 'Hide PoI {{bosses}}',
    //sortChance: 'Sort by chance',
    //sortName: 'Sort alphabetically',
    details: 'Details',
