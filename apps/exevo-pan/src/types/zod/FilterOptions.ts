...
export const FilterOptionsSchema: z.ZodType<Partial<FilterOptions>> = z
  .object({
...
export const PaginationOptionsSchema: z.ZodType<Partial<PaginationOptions>> = z
  .object({
    pageIndex: z.number(),
    pageSize: z.number(),
  })
...
export const SortOptionsSchema: z.ZodType<Partial<SortOptions>> = z
  .object({
