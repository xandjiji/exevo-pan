...
const FavButton = ({
  ...
  const isFavLabel = `${common.CharacterCard.favButton.remove} ${characterObject.nickname} ${common.CharacterCard.favButton.fromFav}`
  const isntFavLabel = `${common.CharacterCard.favButton.add} ${characterObject.nickname} ${common.CharacterCard.favButton.toFav}`
